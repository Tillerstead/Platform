...
(function () {
  ...
  const FORM_CONFIG = {
    ...
    endpoint: '/success/', // Static-site success route; form handling stays external
    successMessage: {
  ...
  async function submitForm(formData) {
    // Primary: Formspree or direct email (public site remains static; no server-side form handling here)
...
Submitted: ${new Date().toLocaleString()}
    ...
    try {
      const formspreeResponse = await fetch('https://formspree.io/f/xpqyeyar', {
        method: 'POST',
      ...
      // // // // // // // // // // // // // // // console.warn('Formspree failed:', _e); // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED // AUTO-DISABLED
    }
